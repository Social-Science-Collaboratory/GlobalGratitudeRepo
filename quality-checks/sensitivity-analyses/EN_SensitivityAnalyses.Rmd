---
title: "EN_SensitivityAnalyses"
author: "Nicholas A. Coles, Annabel V. Dang"
description: "Conduct sensistivity analyses comparing  only English responses to the full dataset"
...
en_unique_country_results_df <- data.frame()
...
# combine all results
en_unique_country_results_df <- do.call(rbind, results_list)

```

#Calculate tau values for English responses
```{r}

en_df <- en_unique_country_results_df %>% 
